...
public interface LoanDAO {
         ...
         */
        @SqlQuery("""
                        SELECT loan_name.loan_name AS loanName, loan.loan_amount as loanAmount
                        FROM loan
                        ...
                        loan.id = :Id
                        """)
        @RegisterBeanMapper(LoanNameAndAmountDTO.class)
        LoanNameAndAmountDTO getLoanNameForLoanRepay(@Bind int Id, @Bind int companyId, @Bind int branchId);
